...
a simplified and synthetic dataset `se_fire_monthly` (100 observations)
...
It provides an interactive Shiny app to explore the relationship between
**Fire Weather Index (FWI)** and **burned area** in south-eastern
Australia.
...
Use this mode if you are contributing or testing the package source
code.
